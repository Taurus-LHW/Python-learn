...
<h1 id="-繁體中文">🏭 程式碼工廠：Python 新手村 (Code Factory)</h1>
...
<h1 id="-english">🏭 Code Factory: Python Beginner's Village</h1>
...
### 🛠️ How to Use & Deploy
1. **Clone the Repo**: Clone this project to your local machine.
2. **Local Preview**: Simply double-click `index.html` to view the full course in your browser.
3. **Deploy with GitHub Pages**: Push to your GitHub repo, go to `Settings -> Pages`, select the `main` branch, and save. Your site will be live in minutes!
